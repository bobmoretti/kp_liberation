...
force ace_maptools_EveryoneCanDrawOnBriefing = true;
...
force ace_medical_maxReviveTime = 180;
...
force ace_sitting_enable = false;
...
force ace_advanced_ballistics_disabledInFullAutoMode = false;
